...
public class PravegaRequestProcessor extends FailingRequestProcessor implements RequestProcessor {
    ...
    private CompletableFuture<Void> truncateIndexSegment(String segment, long offset) {
        ...
        try {
            ...
            CompletableFuture<Void> ex1 = handleExceptionForTruncateSegment(segment, offset, indexSegment, ex);
            if (ex1 != null) {
                return ex1;
            }
    ...
    private CompletableFuture<Void> handleExceptionForTruncateSegment(String segment, long offset, String indexSegment, Throwable ex) {
